...
public class Apuesta extends javax.swing.JFrame {
    ...
    * @return Número final de la operación
    */
    ...
    /**
     * 
     * @param evt Evento de la quiniela ya resuelta
     */
  ...
  /**
   * 
   * @param indice Número del índice
   */
   ...
   /**
    * 
    * @param args Texto que se ha escrito
    */
